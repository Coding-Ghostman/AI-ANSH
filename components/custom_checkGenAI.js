	...
	invoke: async (context, done) => {
		...
		try {
			...
			try {
				...
				const conversationHistory = context.variable(
			...
			logger.error('Error in CUSTOM_Check_GenAi: ' + error);
			context.reply('Sorry, there was an error processing your request.');
		} finally {
			context.transition();
			done();
		}
